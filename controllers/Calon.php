...
class Calon extends CI_Controller {
	...
	public function proses_update(){
		...
		if ($_POST['kirim']) {
			...
			$foto_paslon = '';
			if ($this->upload->do_upload('foto_paslon')) {
				$foto_paslon = $this->upload->file_name;
			}
		// 		print_r($foto_paslon);
		// exit();
			$nama = $_POST['nama'];
		...
		$data = $this->isi_model->isi_data($foto_paslon, $nama, $kelas, $organisasi, $no, $nama_wakil, $kelas_wakil, $organisasi_wakil, $no_wakil, $visi, $misi, $proker, $video, $alamat, $alamat_wakil );
