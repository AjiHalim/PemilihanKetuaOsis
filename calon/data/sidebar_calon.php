      ...
      <nav class="mt-2">
        <ul class="nav nav-pills nav-sidebar flex-column" data-widget="treeview" role="menu" data-accordion="false">
           <li class="nav-header">Anggota</li>
                <li class="nav-item">
                  <a href="<?=base_url('Calon/info')?>" class="nav-link">
                    <i class="fa fa-user-circle" aria-hidden="true" style="margin-left: 6px;"></i>
                    <p style="margin-left: 6px;">Info Data Pribadi</p>
                  </a>
                </li>
                <li class="nav-item">
                  <a href="<?=base_url('Calon/edit')?>" class="nav-link">
                    <i class="fa fa-wrench" aria-hidden="true" style="margin-left: 6px;"></i>
                    <p style="margin-left: 6px;">Pengaturan Data Pribadi</p>
                  </a>
                </li>
