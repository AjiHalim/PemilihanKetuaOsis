                            ...
                            foreach ($list as $value) {  ?>
                              <tr>
                                ...
                                <td>
                                  ...
                                  <?php
                                      ...
                                      if ($selesai == 1) { ?>
                                        <a href="<?=base_url('admin/status_tahun')?>">
                                          <button class="btn btn-primary btn-sm" style="background-color: primary " >Ganti Status</button>
                                        </a>
                                      <?php }else{ ?>
                                          <a href="<?=base_url('admin/status_tahun')?>">
                                  ...
                                  ?>
                                        <a href="<?=base_url('admin/status_tahun')?>">
                                          <button class="btn btn-warning btn-sm" disabled="" style="background-color: warning ">Aktifkan Pemilihan</button>
                                        </a>
                                  <?php 
                                      } else{?>
