 ...
 <!-- Main Sidebar Container -->
   <aside class="main-sidebar sidebar-dark-primary elevation-4 bg-info" >
    <!-- Brand Logo -->
      <a href="<?=base_url('anggota/')?>" class="brand-link" style="border-bottom-color:white !important ; ">
        ...
        <nav class="mt-2" >
          <ul class="nav nav-pills nav-sidebar flex-column" data-widget="treeview" role="menu" data-accordion="false">
            ...
            <li class="nav-header">Profil</li>
              <li class="nav-item">
                <a href="<?=base_url('anggota/info_admin')?>" class="nav-link">
            ...
            <li class="nav-header">Tahun Pemilihan</li>
                <li class="nav-item">
                  <a href="<?=base_url('anggota/lihat_tahun')?>" class="nav-link">
            ...
            <li class="nav-header">Pemilihan</li>
              <li class="nav-item">
                      <a href="<?=base_url('anggota/info_pemilu')?>" class="nav-link" style="margin-left: 6px;">           
